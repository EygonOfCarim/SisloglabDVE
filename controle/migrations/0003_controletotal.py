...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('controle', '0002_controleteste_responsavel_alter_controleteste_mes'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mes', models.CharField(choices=[('1', 'Janeiro'), ('2', 'Fevereiro'), ('3', 'Março'), ('4', 'Abril'), ('5', 'Maio'), ('6', 'Junho'), ('7', 'Julho'), ('8', 'Agosto'), ('9', 'Setembro'), ('10', 'Outubro'), ('11', 'Novembro'), ('12', 'Dezembro')], max_length=3)),
                ('ano', models.CharField(max_length=4)),
            ],
            options={
                'verbose_name': 'Controle Total',
                'verbose_name_plural': 'Controle Total',
            },
        ),
    ]
